...
\usepackage{color} % per definire tutti i colori
\usetheme{Berkeley} %Frankfurt
...
\frametitle{Slide 1}
\begin{itemize}
    \item NASA’s InSight Lander Detects Stunning \textbf{Meteoroid Impact} on Mars.
    \item \pause NASA InSight Study Provides Clearest Look Ever at \textbf{Martian Core}.
\end{itemize}
...
\begin{frame}{Slide 2}
    \includegraphics[width=0.6\textwidth]{sonda_marte.jpg}
    \centering
\end{frame}

\begin{frame}{Slide 3}
    \includegraphics[width=0.8\textwidth]{sonda_marte2.jpg}
    \centering
\end{frame}
...
\begin{frame}{Results}
    \includegraphics[width=0.47\textwidth]{sonda_marte3.jpg}
    \includegraphics[width=0.47\textwidth]{sonda_marte4.jpg}
    \centering
\end{frame}

\begin{frame}{Results}
    \includegraphics[width=0.3\textwidth]{sonda_marte.jpg}
    \includegraphics[width=0.48\textwidth]{sonda_marte2.jpg} \centering \\
    %\bigskip
    \smallskip
    \includegraphics[width=0.48\textwidth]{sonda_marte3.jpg}
    \includegraphics[width=0.48\textwidth]{sonda_marte4.jpg}
    \centering
\end{frame}
